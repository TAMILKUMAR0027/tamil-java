...
public class SeatBooking {
	...
	public static void main(String[] args) {
		...
		char[][] seat= {{'A','A','B','B','A'},{'A','A','A','B','B'},{'A','B','A','B','A'},{'A','A','B','B','A'}};
		...
		System.out.println("VIP Booken seats: "+(seat[0].length-vip)+" Available seats: "+vip+" Total: "+seat[0].length);
		System.out.println("Premimum Booken seats: "+(seat[0].length-pre)+" Available seats: "+pre+" Total: "+seat[0].length);
		System.out.println("Reg Booken seats: "+(seat[0].length-reg)+" Available seats: "+reg+" Total: "+seat[0].length);
